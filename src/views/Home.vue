        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad explora el rol del Estado en el desarrollo moderno, analizando su evolución histórica, desde el Estado mínimo, hasta el Estado eficaz propuesto por el Informe del Banco Mundial de 1997. Se destacan tres pilares fundamentales: adaptar funciones estatales, según capacidades reales, fortalecer instituciones públicas y establecer alianzas estratégicas. Además, se examina la relevancia de este enfoque en Colombia, evidenciando avances y desafíos. Se plantean propuestas jurídicas para consolidar un Estado eficiente, garante de derechos y legitimado por la participación ciudadana, la transparencia y la equidad social.
